...
2. Create a new repository named "MS1-Project". ( change this to hackathon name )
...
1. Login or Sign Up to [GitHub](www.github.com).
2. On GitHub, go to [manni8436/MS1-Project](manni8436/MS1-Project). ( change this to hackathon name )
...
2. Fork the repository manni8436/MS1-Project using the steps above in [How To Fork a Repository](#HOW-TO-FORK-A-REPOSITORY). ( change this to hackathon name )
